...
desired_cap= {
  ...
  "appium:app": "C:\\Users\\meenu\\Downloads\\Flipkart-7.18.apk"
}
...
driver.find_element_by_id("com.flipkart.android:id/phone_input").send_keys("meenusisira@gmail.com")
driver.find_element_by_id("com.flipkart.android:id/button").click()
driver.find_element_by_id("com.flipkart.android:id/phone_input").send_keys("9544245137")
driver.find_element_by_id("com.flipkart.android:id/button").click()
driver.implicitly_wait(30)
...
driver.implicitly_wait(30)
driver.find_element_by_id("com.flipkart.android:id/search_autoCompleteTextView").send_keys("kurtis")
...
driver.find_element_by_xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup[3]/android.view.ViewGroup").click()
